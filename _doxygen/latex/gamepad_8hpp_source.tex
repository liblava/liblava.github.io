...
\DoxyCodeLine{00094\ }
\DoxyCodeLine{00098\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structlava_1_1gamepad}{gamepad}}\ \{}
...
\DoxyCodeLine{00101\ }
\DoxyCodeLine{00103\ \ \ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{structlava_1_1gamepad_ae9c3ebf9c404adc56a5415c6f364a081}{ref}}\ =\ \mbox{\hyperlink{structlava_1_1gamepad}{gamepad}}\ \textcolor{keyword}{const}\&;}
\DoxyCodeLine{00104\ }
...
\DoxyCodeLine{00129\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ state.buttons[\mbox{\hyperlink{types_8hpp_aeeecf3eba131cdad020bbd82d0db68c9}{to\_ui32}}(button)];}
\DoxyCodeLine{00130\ \ \ \ \ \}}
\DoxyCodeLine{00131\ }
...
\DoxyCodeLine{00138\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ state.axes[\mbox{\hyperlink{types_8hpp_aeeecf3eba131cdad020bbd82d0db68c9}{to\_ui32}}(axis)];}
\DoxyCodeLine{00139\ \ \ \ \ \}}
\DoxyCodeLine{00140\ }
...
\DoxyCodeLine{00146\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ pad\_id;}
\DoxyCodeLine{00147\ \ \ \ \ \}}
\DoxyCodeLine{00148\ }
...
\DoxyCodeLine{00165\ \ \ \ \ \mbox{\hyperlink{gamepad_8hpp_a9c84923c4dc78344da664c372a377596}{gamepad\_id}}\ pad\_id;}
\DoxyCodeLine{00166\ }
...
\DoxyCodeLine{00176\ \ \ \ \ \};}
\DoxyCodeLine{00177\ }
\DoxyCodeLine{00179\ \ \ \ \ gamepad::state\ state;}
\DoxyCodeLine{00180\ \};}
\DoxyCodeLine{00181\ }
...
\DoxyCodeLine{00187\ }
\DoxyCodeLine{00191\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structlava_1_1gamepad__manager}{gamepad\_manager}}\ \{}
...
\DoxyCodeLine{00194\ }
\DoxyCodeLine{00199\ \ \ \ \ \textcolor{keyword}{static}\ \mbox{\hyperlink{structlava_1_1gamepad__manager}{gamepad\_manager}}\&\ \mbox{\hyperlink{structlava_1_1gamepad__manager_afad0d16868d78fd3b67e255b26284de3}{singleton}}()\ \{}
\DoxyCodeLine{00200\ \ \ \ \ \ \ \ \ \textcolor{keyword}{static}\ \mbox{\hyperlink{structlava_1_1gamepad__manager}{gamepad\_manager}}\ manager;}
...
\DoxyCodeLine{00221\ \ \ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{structlava_1_1gamepad__manager}{gamepad\_manager}}();}
\DoxyCodeLine{00222\ }
\DoxyCodeLine{00224\ \ \ \ \ \textcolor{keyword}{using\ }listener\_map\ =\ std::map<id,\ listener\_func>;}
\DoxyCodeLine{00225\ }
\DoxyCodeLine{00227\ \ \ \ \ listener\_map\ map;}
\DoxyCodeLine{00228\ \};}
\DoxyCodeLine{00229\ }
