...
\DoxyCodeLine{00020\ }
\DoxyCodeLine{00022\ \textcolor{keyword}{using\ }\mbox{\hyperlink{memory_8hpp_a79fde9f4df3162f37cc199a0adc8fa95}{device\_cptr}}\ =\ \mbox{\hyperlink{structlava_1_1device}{device}}\ \textcolor{keyword}{const}*;}
\DoxyCodeLine{00023\ }
\DoxyCodeLine{00027\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structlava_1_1allocator}{allocator}}\ \{}
\DoxyCodeLine{00029\ \ \ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{structlava_1_1allocator_aebc22fb878bf9a0a94e13518869f1e66}{ptr}}\ =\ std::shared\_ptr<allocator>;}
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00035\ \ \ \ \ \textcolor{keyword}{static}\ \mbox{\hyperlink{structlava_1_1allocator_aebc22fb878bf9a0a94e13518869f1e66}{ptr}}\ \mbox{\hyperlink{structlava_1_1allocator_a05a2bff425899f9d84d33b44a069a0cd}{make}}()\ \{}
...
\DoxyCodeLine{00049\ \ \ \ \ :\ vma\_allocator(\mbox{\hyperlink{structlava_1_1allocator}{allocator}})\ \{\}}
\DoxyCodeLine{00050\ }
\DoxyCodeLine{00057\ \ \ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{structlava_1_1allocator_ad546b8f427aba59865bb4d6670709cf0}{create}}(\mbox{\hyperlink{memory_8hpp_a79fde9f4df3162f37cc199a0adc8fa95}{device\_cptr}}\ \mbox{\hyperlink{structlava_1_1device}{device}},}
...
\DoxyCodeLine{00070\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ vma\_allocator\ !=\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00071\ \ \ \ \ \}}
\DoxyCodeLine{00072\ }
...
\DoxyCodeLine{00078\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ vma\_allocator;}
\DoxyCodeLine{00079\ \ \ \ \ \}}
\DoxyCodeLine{00080\ }
\DoxyCodeLine{00081\ \textcolor{keyword}{private}:}
\DoxyCodeLine{00083\ \ \ \ \ VmaAllocator\ vma\_allocator\ =\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00084\ \};}
\DoxyCodeLine{00085\ }
\DoxyCodeLine{00092\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{structlava_1_1allocator_aebc22fb878bf9a0a94e13518869f1e66}{allocator::ptr}}\ \mbox{\hyperlink{memory_8hpp_ab774057a9a27ab883663654bbdd14a2b}{create\_allocator}}(\mbox{\hyperlink{memory_8hpp_a79fde9f4df3162f37cc199a0adc8fa95}{device\_cptr}}\ \mbox{\hyperlink{structlava_1_1device}{device}},}
\DoxyCodeLine{00093\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ VmaAllocatorCreateFlags\ flags\ =\ 0)\ \{}
\DoxyCodeLine{00094\ \ \ \ \ \textcolor{keyword}{auto}\ result\ =\ \mbox{\hyperlink{structlava_1_1allocator_a05a2bff425899f9d84d33b44a069a0cd}{allocator::make}}();}
...
\DoxyCodeLine{00124\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (use\_custom\_cpu\_callbacks)}
\DoxyCodeLine{00125\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \&vk\_callbacks;}
\DoxyCodeLine{00126\ }
...
\DoxyCodeLine{00135\ \ \ \ \ \ \ \ \ vk\_callbacks\ =\ callbacks;}
\DoxyCodeLine{00136\ \ \ \ \ \}}
\DoxyCodeLine{00137\ }
...
\DoxyCodeLine{00143\ \ \ \ \ \ \ \ \ use\_custom\_cpu\_callbacks\ =\ value;}
\DoxyCodeLine{00144\ \ \ \ \ \}}
\DoxyCodeLine{00145\ }
\DoxyCodeLine{00146\ \textcolor{keyword}{private}:}
\DoxyCodeLine{00148\ \ \ \ \ \textcolor{keywordtype}{bool}\ use\_custom\_cpu\_callbacks\ =\ \textcolor{keyword}{true};}
\DoxyCodeLine{00149\ }
\DoxyCodeLine{00151\ \ \ \ \ VkAllocationCallbacks\ vk\_callbacks\ =\ \{\};}
\DoxyCodeLine{00152\ \};}
\DoxyCodeLine{00153\ }
