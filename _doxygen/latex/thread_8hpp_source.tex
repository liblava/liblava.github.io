...
\DoxyCodeLine{00014\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{id_8hpp}{liblava/core/id.hpp}}"{}}}
\DoxyCodeLine{00015\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{time_8hpp}{liblava/core/time.hpp}}"{}}}
\DoxyCodeLine{00016\ }
...
\DoxyCodeLine{00056\ \ \ \ \ \ \ \ \ \ \ \ \ workers.emplace\_back(worker(*\textcolor{keyword}{this}));}
\DoxyCodeLine{00057\ \ \ \ \ \}}
\DoxyCodeLine{00058\ }
...
\DoxyCodeLine{00063\ \ \ \ \ \ \ \ \ stop\ =\ \textcolor{keyword}{true};}
\DoxyCodeLine{00064\ \ \ \ \ \ \ \ \ condition.notify\_all();}
\DoxyCodeLine{00065\ }
\DoxyCodeLine{00066\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keyword}{auto}\&\ worker\ :\ workers)}
\DoxyCodeLine{00067\ \ \ \ \ \ \ \ \ \ \ \ \ worker.join();}
\DoxyCodeLine{00068\ }
\DoxyCodeLine{00069\ \ \ \ \ \ \ \ \ workers.clear();}
\DoxyCodeLine{00070\ \ \ \ \ \}}
\DoxyCodeLine{00071\ }
...
\DoxyCodeLine{00077\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00078\ \ \ \ \ \ \ \ \ \ \ \ \ std::unique\_lock<std::mutex>\ lock(queue\_mutex);}
\DoxyCodeLine{00079\ \ \ \ \ \ \ \ \ \ \ \ \ tasks.push\_back(\mbox{\hyperlink{structlava_1_1thread__pool_aaf79c28a670fa80d6dd01c8c22cec577}{task}}(f));}
\DoxyCodeLine{00080\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00081\ \ \ \ \ \ \ \ \ condition.notify\_one();}
\DoxyCodeLine{00082\ \ \ \ \ \}}
\DoxyCodeLine{00083\ }
...
\DoxyCodeLine{00104\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00105\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ std::unique\_lock<std::mutex>\ lock(pool.queue\_mutex);}
\DoxyCodeLine{00106\ }
\DoxyCodeLine{00107\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{while}\ (!pool.stop\ \&\&\ pool.tasks.empty())}
\DoxyCodeLine{00108\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ pool.condition.wait(lock);}
\DoxyCodeLine{00109\ }
\DoxyCodeLine{00110\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (pool.stop)}
\DoxyCodeLine{00111\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00112\ }
\DoxyCodeLine{00113\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structlava_1_1thread__pool_aaf79c28a670fa80d6dd01c8c22cec577}{task}}\ =\ pool.tasks.front();}
\DoxyCodeLine{00114\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ pool.tasks.pop\_front();}
\DoxyCodeLine{00115\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00116\ }
...
\DoxyCodeLine{00123\ \ \ \ \ \ \ \ \ thread\_pool\&\ pool;}
\DoxyCodeLine{00124\ \ \ \ \ \};}
\DoxyCodeLine{00125\ }
\DoxyCodeLine{00127\ \ \ \ \ std::vector<std::thread>\ workers;}
\DoxyCodeLine{00128\ }
\DoxyCodeLine{00130\ \ \ \ \ std::deque<task>\ tasks;}
\DoxyCodeLine{00131\ }
\DoxyCodeLine{00133\ \ \ \ \ std::mutex\ queue\_mutex;}
\DoxyCodeLine{00134\ }
\DoxyCodeLine{00136\ \ \ \ \ std::condition\_variable\ condition;}
\DoxyCodeLine{00137\ }
\DoxyCodeLine{00139\ \ \ \ \ \textcolor{keywordtype}{bool}\ stop\ =\ \textcolor{keyword}{false};}
\DoxyCodeLine{00140\ \};}
\DoxyCodeLine{00141\ }
