...
|                | Name           |
| -------------- | -------------- |
| using std::shared_ptr< [render_pass](/_doxybook/Classes/structlava_1_1render__pass.md) > | **[ptr](/_doxybook/Classes/structlava_1_1render__pass.md#using-ptr)** <br>Shared pointer to render pass.  |
| using std::vector< [ptr](/_doxybook/Classes/structlava_1_1render__pass.md#using-ptr) > | **[list](/_doxybook/Classes/structlava_1_1render__pass.md#using-list)** <br>List of render passes.  |

## Public Functions

|                | Name           |
| -------------- | -------------- |
| [ptr](/_doxybook/Classes/structlava_1_1render__pass.md#using-ptr) | **[make](/_doxybook/Classes/structlava_1_1render__pass.md#function-make)**([device_p](/_doxybook/Namespaces/namespacelava.md#using-device-p) device)<br>Make a new render pass.  |
| | **[render_pass](/_doxybook/Classes/structlava_1_1render__pass.md#function-render-pass)**([device_p](/_doxybook/Namespaces/namespacelava.md#using-device-p) device)<br>Construct a new render pass.  |
...
| [device_p](/_doxybook/Namespaces/namespacelava.md#using-device-p) | **[get_device](/_doxybook/Classes/structlava_1_1render__pass.md#function-get-device)**()<br>Get the device.  |
...
| [subpass::list](/_doxybook/Classes/structlava_1_1subpass.md#using-list) const & | **[get_subpasses](/_doxybook/Classes/structlava_1_1render__pass.md#function-get-subpasses)**() const<br>Get the subpasses.  |
| void | **[add](/_doxybook/Classes/structlava_1_1render__pass.md#function-add)**([attachment::ptr](/_doxybook/Classes/structlava_1_1attachment.md#using-ptr) const & attachment)<br>Add an attachment.  |
| void | **[add](/_doxybook/Classes/structlava_1_1render__pass.md#function-add)**([subpass_dependency::ptr](/_doxybook/Classes/structlava_1_1subpass__dependency.md#using-ptr) const & dependency)<br>Add a subpass dependency.  |
| void | **[add](/_doxybook/Classes/structlava_1_1render__pass.md#function-add)**([subpass::ptr](/_doxybook/Classes/structlava_1_1subpass.md#using-ptr) const & subpass)<br>Add a subpass.  |
...
| void | **[add](/_doxybook/Classes/structlava_1_1render__pass.md#function-add)**([render_pipeline::ptr](/_doxybook/Classes/structlava_1_1render__pipeline.md#using-ptr) pipeline, [index](/_doxybook/Namespaces/namespacelava.md#using-index) subpass =0)<br>Add a render pipeline to the back of subpass.  |
| void | **[add_front](/_doxybook/Classes/structlava_1_1render__pass.md#function-add-front)**([render_pipeline::ptr](/_doxybook/Classes/structlava_1_1render__pipeline.md#using-ptr) pipeline, [index](/_doxybook/Namespaces/namespacelava.md#using-index) subpass =0)<br>Add a render pipeline to the front of subpass.  |
| void | **[remove](/_doxybook/Classes/structlava_1_1render__pass.md#function-remove)**([render_pipeline::ptr](/_doxybook/Classes/structlava_1_1render__pipeline.md#using-ptr) pipeline, [index](/_doxybook/Namespaces/namespacelava.md#using-index) subpass =0)<br>Remove a render pipeline from the subpass.  |
...
```cpp
using lava::render_pass::ptr =  std::shared_ptr<render_pass>;
```
...
```cpp
using lava::render_pass::list =  std::vector<ptr>;
```
...
```cpp
inline subpass::list const & get_subpasses() const
```

Get the subpasses. 

**Return**: [subpass::list](/_doxybook/Classes/structlava_1_1subpass.md#using-list) const& List of subpasses 

### function add

```cpp
inline void add(
    attachment::ptr const & attachment
)
```
...
```cpp
inline void add(
    subpass_dependency::ptr const & dependency
)
```
