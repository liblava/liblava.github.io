...
|                | Name           |
| -------------- | -------------- |
| [ptr](/_doxybook/Classes/structlava_1_1image.md#using-ptr) | **[make](/_doxybook/Classes/structlava_1_1image.md#function-make)**(VkFormat format, VkImage vk_image =0)<br>Make a new image.  |
...
| bool | **[create](/_doxybook/Classes/structlava_1_1image.md#function-create)**([device_p](/_doxybook/Namespaces/namespacelava.md#using-device-p) device, [uv2](/_doxybook/Namespaces/namespacelava.md#using-uv2) size, VmaMemoryUsage memory_usage =VMA_MEMORY_USAGE_GPU_ONLY, bool mip_levels_generation =false)<br>Create a new image.  |
...
**Parameters**: 
  ...
  * **mip_levels_generation** Enable mip levels generation 
