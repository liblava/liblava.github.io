...
| bool | **[set](/_doxybook/Classes/structlava_1_1data.md#function-set)**([size_t](/_doxybook/Namespaces/namespacelava.md#using-size-t) length, [data_mode](/_doxybook/Namespaces/namespacelava.md#enum-data-mode) mode =data_mode::alloc)<br>Set and allocate data by length.  |
