...
|                | Name           |
| -------------- | -------------- |
| using [id](/_doxybook/Classes/structlava_1_1id.md)[const](/_doxybook/Classes/structlava_1_1id.md#using-map)  & | **[ref](/_doxybook/Classes/structlava_1_1id.md#using-ref)** <br>Reference to id.  |
| using std::set< [id](/_doxybook/Classes/structlava_1_1id.md) > | **[set](/_doxybook/Classes/structlava_1_1id.md#using-set)** <br>Set of ids.  |
| using [set](/_doxybook/Classes/structlava_1_1id.md#using-set)[const](/_doxybook/Classes/structlava_1_1id.md#using-map)  & | **[set_ref](/_doxybook/Classes/structlava_1_1id.md#using-set-ref)** <br>Reference to set of ids.  |
...
| [bool](/_doxybook/Classes/structlava_1_1id.md#using-map) | **[valid](/_doxybook/Classes/structlava_1_1id.md#function-valid)**() const<br>Check if the id is valid.  |
...
| [void](/_doxybook/Classes/structlava_1_1id.md#using-map) | **[invalidate](/_doxybook/Classes/structlava_1_1id.md#function-invalidate)**()<br>Invalidate id.  |
| [auto](/_doxybook/Classes/structlava_1_1id.md#using-map) | **[operator<=>](/_doxybook/Classes/structlava_1_1id.md#function-operator<=>)**([id](/_doxybook/Classes/structlava_1_1id.md)[const](/_doxybook/Classes/structlava_1_1id.md#using-map) & ) const =default<br>Compare operator.  |
