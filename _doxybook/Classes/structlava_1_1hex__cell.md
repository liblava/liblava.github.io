...
|                | Name           |
| -------------- | -------------- |
| [auto](/_doxybook/Classes/structlava_1_1hex__cell.md#using-map) | **[operator<=>](/_doxybook/Classes/structlava_1_1hex__cell.md#function-operator<=>)**([hex_cell](/_doxybook/Classes/structlava_1_1hex__cell.md)[const](/_doxybook/Classes/structlava_1_1hex__cell.md#using-map) & ) const =default<br>Compare operator.  |
...
| [void](/_doxybook/Classes/structlava_1_1hex__cell.md#using-map) | **[add](/_doxybook/Classes/structlava_1_1hex__cell.md#function-add)**([hex_cell](/_doxybook/Classes/structlava_1_1hex__cell.md)[const](/_doxybook/Classes/structlava_1_1hex__cell.md#using-map) & cell)<br>Add hex cell.  |
| [void](/_doxybook/Classes/structlava_1_1hex__cell.md#using-map) | **[substract](/_doxybook/Classes/structlava_1_1hex__cell.md#function-substract)**([hex_cell](/_doxybook/Classes/structlava_1_1hex__cell.md)[const](/_doxybook/Classes/structlava_1_1hex__cell.md#using-map) & cell)<br>Substract hex cell.  |
| [void](/_doxybook/Classes/structlava_1_1hex__cell.md#using-map) | **[scale](/_doxybook/Classes/structlava_1_1hex__cell.md#function-scale)**([i32](/_doxybook/Namespaces/namespacelava.md#using-i32) factor)<br>Scale the hex cell.  |
| [void](/_doxybook/Classes/structlava_1_1hex__cell.md#using-map) | **[rotate_left](/_doxybook/Classes/structlava_1_1hex__cell.md#function-rotate-left)**()<br>Rotate to left.  |
| [void](/_doxybook/Classes/structlava_1_1hex__cell.md#using-map) | **[rotate_right](/_doxybook/Classes/structlava_1_1hex__cell.md#function-rotate-right)**()<br>Rotate to right.  |
