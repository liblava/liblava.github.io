...
|                | Name           |
| -------------- | -------------- |
| using std::shared_ptr< [attachment](/_doxybook/Classes/structlava_1_1attachment.md) > | **[ptr](/_doxybook/Classes/structlava_1_1attachment.md#using-ptr)** <br>Shared pointer to attachment.  |
| using std::vector< [ptr](/_doxybook/Classes/structlava_1_1attachment.md#using-ptr) > | **[list](/_doxybook/Classes/structlava_1_1attachment.md#using-list)** <br>List of attachments.  |

## Public Functions

|                | Name           |
| -------------- | -------------- |
| [ptr](/_doxybook/Classes/structlava_1_1attachment.md#using-ptr) | **[make](/_doxybook/Classes/structlava_1_1attachment.md#function-make)**(VkFormat format =VK_FORMAT_UNDEFINED, VkSampleCountFlagBits samples =VK_SAMPLE_COUNT_1_BIT)<br>Make a new attachment.  |
...
```cpp
using lava::attachment::ptr =  std::shared_ptr<attachment>;
```
...
```cpp
using lava::attachment::list =  std::vector<ptr>;
```
