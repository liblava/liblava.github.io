...
| bool | **[create](/_doxybook/Classes/structlava_1_1mesh__template.md#function-create)**([device_p](/_doxybook/Namespaces/namespacelava.md#using-device-p) device, bool mapped =false, VmaMemoryUsage memory_usage =VMA_MEMORY_USAGE_CPU_TO_GPU)<br>Create a new mesh.  |
