...
|                | Name           |
| -------------- | -------------- |
| [ptr](/_doxybook/Classes/structlava_1_1compute__pipeline.md#using-ptr) | **[make](/_doxybook/Classes/structlava_1_1compute__pipeline.md#function-make)**([device_p](/_doxybook/Namespaces/namespacelava.md#using-device-p) device, [VkPipelineCache](/_doxybook/Classes/structlava_1_1compute__pipeline.md#using-map) pipeline_cache =0)<br>Make a new compute pipeline.  |
| virtual [void](/_doxybook/Classes/structlava_1_1compute__pipeline.md#using-map) | **[bind](/_doxybook/Classes/structlava_1_1compute__pipeline.md#function-bind)**([VkCommandBuffer](/_doxybook/Classes/structlava_1_1compute__pipeline.md#using-map) cmdBuffer) override<br>Bind the pipeline.  |
| [bool](/_doxybook/Classes/structlava_1_1compute__pipeline.md#using-map) | **[set_shader_stage](/_doxybook/Classes/structlava_1_1compute__pipeline.md#function-set-shader-stage)**([cdata::ref](/_doxybook/Classes/structlava_1_1cdata.md#using-ref) data, [VkShaderStageFlagBits](/_doxybook/Classes/structlava_1_1compute__pipeline.md#using-map) stage)<br>Set shader stage.  |
| [void](/_doxybook/Classes/structlava_1_1compute__pipeline.md#using-map) | **[set](/_doxybook/Classes/structlava_1_1compute__pipeline.md#function-set)**(shader_stage::ptr [const](/_doxybook/Classes/structlava_1_1compute__pipeline.md#using-map) & stage)<br>Set shader stage.  |
| shader_stage::ptr [const](/_doxybook/Classes/structlava_1_1compute__pipeline.md#using-map) & | **[get_shader_stage](/_doxybook/Classes/structlava_1_1compute__pipeline.md#function-get-shader-stage)**() const<br>Get the shader stage.  |
| [void](/_doxybook/Classes/structlava_1_1compute__pipeline.md#using-map) | **[copy_to](/_doxybook/Classes/structlava_1_1compute__pipeline.md#function-copy-to)**([compute_pipeline](/_doxybook/Classes/structlava_1_1compute__pipeline.md) * target) const<br>Copy configuration to target pipeline.  |
| [void](/_doxybook/Classes/structlava_1_1compute__pipeline.md#using-map) | **[copy_from](/_doxybook/Classes/structlava_1_1compute__pipeline.md#function-copy-from)**([ptr](/_doxybook/Classes/structlava_1_1compute__pipeline.md#using-ptr)[const](/_doxybook/Classes/structlava_1_1compute__pipeline.md#using-map) & source)<br>Copy configuration from source.  |
| | **[pipeline](/_doxybook/Classes/structlava_1_1compute__pipeline.md#function-pipeline)**([device_p](/_doxybook/Namespaces/namespacelava.md#using-device-p) device, [VkPipelineCache](/_doxybook/Classes/structlava_1_1compute__pipeline.md#using-map) pipeline_cache =0)<br>Pipeline constructors.  |
