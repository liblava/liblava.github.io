...
|                | Name           |
| -------------- | -------------- |
| using std::shared_ptr< [render_target](/_doxybook/Classes/structlava_1_1render__target.md) > | **[ptr](/_doxybook/Classes/structlava_1_1render__target.md#using-ptr)** <br>Shared pointer to render target.  |
...
|                | Name           |
| -------------- | -------------- |
| [ptr](/_doxybook/Classes/structlava_1_1render__target.md#using-ptr) | **[make](/_doxybook/Classes/structlava_1_1render__target.md#function-make)**()<br>Make a new render target.  |
| bool | **[create](/_doxybook/Classes/structlava_1_1render__target.md#function-create)**([device_p](/_doxybook/Namespaces/namespacelava.md#using-device-p) device, VkSurfaceKHR surface, VkSurfaceFormatKHR format, [uv2](/_doxybook/Namespaces/namespacelava.md#using-uv2) size, bool v_sync =false)<br>Create a new render target.  |
...
| [device_p](/_doxybook/Namespaces/namespacelava.md#using-device-p) | **[get_device](/_doxybook/Classes/structlava_1_1render__target.md#function-get-device)**()<br>Get the device.  |
...
| [image::list](/_doxybook/Classes/structlava_1_1image.md#using-list) const & | **[get_backbuffers](/_doxybook/Classes/structlava_1_1render__target.md#function-get-backbuffers)**() const<br>Get the backbuffers.  |
| [image::ptr](/_doxybook/Classes/structlava_1_1image.md#using-ptr) | **[get_backbuffer](/_doxybook/Classes/structlava_1_1render__target.md#function-get-backbuffer)**([index](/_doxybook/Namespaces/namespacelava.md#using-index) index)<br>Get the backbuffer by frame index.  |
...
| void | **[add_callback](/_doxybook/Classes/structlava_1_1render__target.md#function-add-callback)**([target_callback::cptr](/_doxybook/Classes/structlava_1_1target__callback.md#using-cptr) callback)<br>Add callback.  |
| void | **[remove_callback](/_doxybook/Classes/structlava_1_1render__target.md#function-remove-callback)**([target_callback::cptr](/_doxybook/Classes/structlava_1_1target__callback.md#using-cptr) callback)<br>Remove callback.  |
...
```cpp
using lava::render_target::ptr =  std::shared_ptr<render_target>;
```
...
```cpp
inline image::list const & get_backbuffers() const
```

Get the backbuffers. 

**Return**: [image::list](/_doxybook/Classes/structlava_1_1image.md#using-list) const& List of backbuffer images 

### function get_backbuffer

```cpp
inline image::ptr get_backbuffer(
    index index
)
```
...
**Return**: [image::ptr](/_doxybook/Classes/structlava_1_1image.md#using-ptr) Backbuffer image 
