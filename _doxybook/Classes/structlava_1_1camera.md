...
|                | Name           |
| -------------- | -------------- |
| bool | **[create](/_doxybook/Classes/structlava_1_1camera.md#function-create)**([device_p](/_doxybook/Namespaces/namespacelava.md#using-device-p) device)<br>Create a camera.  |
...
| [mat4](/_doxybook/Namespaces/namespacelava.md#using-mat4) | **[get_view_projection](/_doxybook/Classes/structlava_1_1camera.md#function-get-view-projection)**() const<br>Get the camera's combined 4x4 view/projection matrix.  |
...
### function get_view_projection

```cpp
mat4 get_view_projection() const
```

Get the camera's combined 4x4 view/projection matrix. 
