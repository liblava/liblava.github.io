...
|                | Name           |
| -------------- | -------------- |
| using std::shared_ptr< [subpass](/_doxybook/Classes/structlava_1_1subpass.md) > | **[ptr](/_doxybook/Classes/structlava_1_1subpass.md#using-ptr)** <br>Shared pointer to subpass.  |
| using std::vector< [ptr](/_doxybook/Classes/structlava_1_1subpass.md#using-ptr) > | **[list](/_doxybook/Classes/structlava_1_1subpass.md#using-list)** <br>List of subpasses.  |

## Public Functions

|                | Name           |
| -------------- | -------------- |
| [ptr](/_doxybook/Classes/structlava_1_1subpass.md#using-ptr) | **[make](/_doxybook/Classes/structlava_1_1subpass.md#function-make)**(VkPipelineBindPoint pipeline_bind_point =VK_PIPELINE_BIND_POINT_GRAPHICS)<br>Make a new subpass.  |
...
| void | **[add](/_doxybook/Classes/structlava_1_1subpass.md#function-add)**([render_pipeline::ptr](/_doxybook/Classes/structlava_1_1render__pipeline.md#using-ptr) const & pipeline)<br>Add a render pipeline to the back of the subpass.  |
| void | **[add_front](/_doxybook/Classes/structlava_1_1subpass.md#function-add-front)**([render_pipeline::ptr](/_doxybook/Classes/structlava_1_1render__pipeline.md#using-ptr) const & pipeline)<br>Add a render pipeline to the fronst of the subpass.  |
| void | **[remove](/_doxybook/Classes/structlava_1_1subpass.md#function-remove)**([render_pipeline::ptr](/_doxybook/Classes/structlava_1_1render__pipeline.md#using-ptr) pipeline)<br>Remove the render pipeline.  |
...
```cpp
using lava::subpass::ptr =  std::shared_ptr<subpass>;
```
...
```cpp
using lava::subpass::list =  std::vector<ptr>;
```
...
```cpp
inline void add(
    render_pipeline::ptr const & pipeline
)
```
