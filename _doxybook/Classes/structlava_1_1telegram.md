...
| using std::set< [telegram](/_doxybook/Classes/structlava_1_1telegram.md) > | **[set](/_doxybook/Classes/structlava_1_1telegram.md#using-set)** <br>Set of telegrams.  |
...
```cpp
using lava::telegram::set =  std::set<telegram>;
```
