...
| using std::function< void([ptr](/_doxybook/Classes/structlava_1_1window.md#using-ptr))> | **[event](/_doxybook/Classes/structlava_1_1window.md#using-event)** <br>Window event function.  |
...
| float | **[get_aspect_ratio](/_doxybook/Classes/structlava_1_1window.md#function-get-aspect-ratio)**() const<br>Get the aspect ratio of window.  |
...
| void | **[assign](/_doxybook/Classes/structlava_1_1window.md#function-assign)**([input](/_doxybook/Classes/structlava_1_1input.md) * callback)<br>Assign input callback.  |
...
| void | **[set_icon](/_doxybook/Classes/structlava_1_1window.md#function-set-icon)**([data_cptr](/_doxybook/Namespaces/namespacelava.md#using-data-cptr) data, [uv2](/_doxybook/Namespaces/namespacelava.md#using-uv2) size)<br>Set the window icon.  |
| [index](/_doxybook/Namespaces/namespacelava.md#using-index) | **[get_monitor](/_doxybook/Classes/structlava_1_1window.md#function-get-monitor)**() const<br>Get the monitor index of the window.  |
