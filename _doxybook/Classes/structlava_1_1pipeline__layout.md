...
|                | Name           |
| -------------- | -------------- |
| using std::shared_ptr< [pipeline_layout](/_doxybook/Classes/structlava_1_1pipeline__layout.md) > | **[ptr](/_doxybook/Classes/structlava_1_1pipeline__layout.md#using-ptr)** <br>Shared pointer to pipeline layout.  |
| using std::vector< [ptr](/_doxybook/Classes/structlava_1_1pipeline__layout.md#using-ptr) > | **[list](/_doxybook/Classes/structlava_1_1pipeline__layout.md#using-list)** <br>List of pipeline layouts.  |
...
|                | Name           |
| -------------- | -------------- |
| [ptr](/_doxybook/Classes/structlava_1_1pipeline__layout.md#using-ptr) | **[make](/_doxybook/Classes/structlava_1_1pipeline__layout.md#function-make)**()<br>Make a new pipeline layout.  |
| void | **[add](/_doxybook/Classes/structlava_1_1pipeline__layout.md#function-add)**([descriptor::ptr](/_doxybook/Classes/structlava_1_1descriptor.md#using-ptr) const & descriptor) |
| void | **[add](/_doxybook/Classes/structlava_1_1pipeline__layout.md#function-add)**(VkPushConstantRange const & range) |
| void | **[add_descriptor](/_doxybook/Classes/structlava_1_1pipeline__layout.md#function-add-descriptor)**([descriptor::ptr](/_doxybook/Classes/structlava_1_1descriptor.md#using-ptr) const & descriptor)<br>Add descriptor.  |
...
| bool | **[create](/_doxybook/Classes/structlava_1_1pipeline__layout.md#function-create)**([device_p](/_doxybook/Namespaces/namespacelava.md#using-device-p) device)<br>Create a new pipeline layout.  |
...
| [device_p](/_doxybook/Namespaces/namespacelava.md#using-device-p) | **[get_device](/_doxybook/Classes/structlava_1_1pipeline__layout.md#function-get-device)**()<br>Get the device.  |
| [descriptor::list](/_doxybook/Classes/structlava_1_1descriptor.md#using-list) const & | **[get_descriptors](/_doxybook/Classes/structlava_1_1pipeline__layout.md#function-get-descriptors)**() const<br>Get the descriptors.  |
...
```cpp
using lava::pipeline_layout::ptr =  std::shared_ptr<pipeline_layout>;
```
...
```cpp
using lava::pipeline_layout::list =  std::vector<ptr>;
```
...
```cpp
inline void add(
    descriptor::ptr const & descriptor
)
```
...
```cpp
inline descriptor::list const & get_descriptors() const
```

Get the descriptors. 

**Return**: [descriptor::list](/_doxybook/Classes/structlava_1_1descriptor.md#using-list) const& List of descriptors 
