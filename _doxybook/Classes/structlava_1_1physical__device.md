...
|                | Name           |
| -------------- | -------------- |
| using std::shared_ptr< [physical_device](/_doxybook/Classes/structlava_1_1physical__device.md) > | **[ptr](/_doxybook/Classes/structlava_1_1physical__device.md#using-ptr)** <br>Shared pointer to physical device.  |
| using std::vector< [ptr](/_doxybook/Classes/structlava_1_1physical__device.md#using-ptr) > | **[list](/_doxybook/Classes/structlava_1_1physical__device.md#using-list)** <br>List of physical devices.  |
...
|                | Name           |
| -------------- | -------------- |
| [ptr](/_doxybook/Classes/structlava_1_1physical__device.md#using-ptr) | **[make](/_doxybook/Classes/structlava_1_1physical__device.md#function-make)**(VkPhysicalDevice vk_physical_device)<br>Make a new physical device.  |
...
| [int_version](/_doxybook/Namespaces/namespacelava.md#using-int-version) | **[get_driver_version](/_doxybook/Classes/structlava_1_1physical__device.md#function-get-driver-version)**() const<br>Get the driver version.  |
...
```cpp
using lava::physical_device::ptr =  std::shared_ptr<physical_device>;
```
...
```cpp
using lava::physical_device::list =  std::vector<ptr>;
```
