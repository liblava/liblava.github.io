...
| using [command](/_doxybook/Classes/structlava_1_1command.md) const  * | **[cptr](/_doxybook/Classes/structlava_1_1block.md#using-cptr)** <br>Const pointer to block.  |
...
| bool | **[create](/_doxybook/Classes/structlava_1_1block.md#function-create)**([device_p](/_doxybook/Namespaces/namespacelava.md#using-device-p) device, [index](/_doxybook/Namespaces/namespacelava.md#using-index) frame_count, [index](/_doxybook/Namespaces/namespacelava.md#using-index) queue_family)<br>Create a new block.  |
...
| [VkCommandBuffers](/_doxybook/Namespaces/namespacelava.md#using-vkcommandbuffers) | **[get_buffers](/_doxybook/Classes/structlava_1_1block.md#function-get-buffers)**()<br>Get the buffers.  |
| [command::map](/_doxybook/Classes/structlava_1_1command.md#using-map) const & | **[get_commands](/_doxybook/Classes/structlava_1_1block.md#function-get-commands)**() const<br>Get the commands.  |
| [command::clist](/_doxybook/Classes/structlava_1_1command.md#using-clist) const & | **[get_cmd_order](/_doxybook/Classes/structlava_1_1block.md#function-get-cmd-order)**() const<br>Get the cmd order.  |
...
```cpp
inline VkCommandBuffers get_buffers()
```
...
```cpp
inline command::map const & get_commands() const
```
...
```cpp
inline command::clist const & get_cmd_order() const
```
