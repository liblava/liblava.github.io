...
|                | Name           |
| -------------- | -------------- |
| using std::shared_ptr< [binding](/_doxybook/Classes/structlava_1_1descriptor_1_1binding.md) > | **[ptr](/_doxybook/Classes/structlava_1_1descriptor_1_1binding.md#using-ptr)** <br>Shared pointer to binding.  |
| using std::vector< [ptr](/_doxybook/Classes/structlava_1_1descriptor_1_1binding.md#using-ptr) > | **[list](/_doxybook/Classes/structlava_1_1descriptor_1_1binding.md#using-list)** <br>List of bindings.  |

## Public Functions

|                | Name           |
| -------------- | -------------- |
| [ptr](/_doxybook/Classes/structlava_1_1descriptor_1_1binding.md#using-ptr) | **[make](/_doxybook/Classes/structlava_1_1descriptor_1_1binding.md#function-make)**([index](/_doxybook/Namespaces/namespacelava.md#using-index) index)<br>Make a new descriptor binding.  |
...
```cpp
using lava::descriptor::binding::ptr =  std::shared_ptr<binding>;
```
...
```cpp
using lava::descriptor::binding::list =  std::vector<ptr>;
```
