...
|                | Name           |
| -------------- | -------------- |
| using std::shared_ptr< [device](/_doxybook/Classes/structlava_1_1device.md) > | **[ptr](/_doxybook/Classes/structlava_1_1device.md#using-ptr)** <br>Shared pointer to a device.  |
| using std::vector< [ptr](/_doxybook/Classes/structlava_1_1device.md#using-ptr) > | **[list](/_doxybook/Classes/structlava_1_1device.md#using-list)** <br>List of devices.  |

## Public Functions

|                | Name           |
| -------------- | -------------- |
| [ptr](/_doxybook/Classes/structlava_1_1device.md#using-ptr) | **[make](/_doxybook/Classes/structlava_1_1device.md#function-make)**()<br>Make a new device.  |
...
| [physical_device_cp](/_doxybook/Namespaces/namespacelava.md#using-physical-device-cp) | **[get_physical_device](/_doxybook/Classes/structlava_1_1device.md#function-get-physical-device)**() const<br>Get the physical device.  |
...
| void | **[set_allocator](/_doxybook/Classes/structlava_1_1device.md#function-set-allocator)**([allocator::ptr](/_doxybook/Classes/structlava_1_1allocator.md#using-ptr) value)<br>Set the allocator for this device.  |
| [allocator::ptr](/_doxybook/Classes/structlava_1_1allocator.md#using-ptr) | **[get_allocator](/_doxybook/Classes/structlava_1_1device.md#function-get-allocator)**()<br>Get the allocator of this device.  |
...
```cpp
using lava::device::ptr =  std::shared_ptr<device>;
```
...
```cpp
using lava::device::list =  std::vector<ptr>;
```
...
```cpp
inline physical_device_cp get_physical_device() const
```
...
```cpp
inline allocator::ptr get_allocator()
```
