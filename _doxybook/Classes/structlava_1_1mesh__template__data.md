...
|                | Name           |
| -------------- | -------------- |
| template <typename PosType  =float\> <br>void | **[move](/_doxybook/Classes/structlava_1_1mesh__template__data.md#function-move)**(std::array< PosType, 3 > offset)<br>Move mesh data by offset.  |
...
| template <typename PosType  =float\> <br>void | **[scale_vector](/_doxybook/Classes/structlava_1_1mesh__template__data.md#function-scale-vector)**(std::array< PosType, 3 > factors)<br>Scale mesh data by vector.  |
