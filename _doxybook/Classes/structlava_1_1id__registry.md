...
| void | **[add](/_doxybook/Classes/structlava_1_1id__registry.md#function-add)**([ptr](/_doxybook/Classes/structlava_1_1id__registry.md#using-ptr) object, Meta info ={})<br>Add a object with meta to registry.  |
...
| [map](/_doxybook/Classes/structlava_1_1id__registry.md#using-map) const & | **[get_all](/_doxybook/Classes/structlava_1_1id__registry.md#function-get-all)**() const<br>Get all objects.  |
...
```cpp
inline map const & get_all() const
```
